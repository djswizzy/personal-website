...
document.addEventListener("DOMContentLoaded", function () {
  const username = "djswizzy"; // Your GitHub username (lowercase for better compatibility)
  ...
  function renderHeatmap() {
    ...
    calendar.innerHTML = `
      <div class="calendar-wrapper">
        <iframe
          src="https://github-readme-streak-stats.herokuapp.com/?user=djswizzy&theme=default&hide_border=true"
          width="100%"
          height="180"
          frameborder="0"
          scrolling="no"
        ...
        <iframe
          src="https://github-readme-stats.vercel.app/api?username=djswizzy&show_icons=true&count_private=true&include_all_commits=true&hide_border=true"
          width="100%"
          height="180"
          frameborder="0"
          scrolling="no"
        ...
        <iframe
          src="https://ghchart.rshah.org/djswizzy"
          width="100%"
          height="120"
          frameborder="0"
          scrolling="no"
